            ...
            while (opcion1 != "4")
            {
                ...
                switch (opcion1)
                {
                    ...
                    case "1":                        
                        ...
                        // Se incializan variables para su uso indeterminado.
                        QUEUE = new List<Vertices>();
                        listaVertices = new List<Vertices>();
                        counter = 1; index = 0;
                        ...
                        while (counter < maxVertices)
                        {
                            ...
                            if (opcionAdv == "S")
                            {
                                ...
                                listaVertices.Add(new Vertices() { State = 1, PastV = listaVerticesTemp[index], Data = dataVerticeTemp });
                    ...
                    case "2":
                        ...
                        Console.WriteLine("Gracias por utilizar ASAAT ---- Breath First Search | Metodo de busqueda por anchura");
